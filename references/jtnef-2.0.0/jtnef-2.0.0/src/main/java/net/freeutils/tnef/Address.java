...
public class Address {
    ...
    public Address(RawInputStream data) throws IOException {
        ...
        displayName = data.readString(displayNameLength);
        int addressLength = data.readU16();
        String typeAndAddress = data.readString(addressLength);
        int separator = typeAndAddress.indexOf(':');
        type = typeAndAddress.substring(0, separator);
        address = typeAndAddress.substring(separator + 1);
    }
    ...
    public String toString() {
        return new StringBuilder()
            ...
            .append(type).append(':').append(address).append(']')
            .toString();
    }
