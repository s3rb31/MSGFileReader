 ...
 * @since 2003-04-25
 */
public class Attr implements Closeable {
    ...
    public void close() throws IOException {
        ...
        else if (data instanceof MAPIProps[])
            TNEFUtils.closeAll((MAPIProps[])data);
    }
    ...
    public String toString() {
        ...
        s.append("Attr:")
            ...
            .append(" type=").append(TNEFUtils.getConstName(getClass(), "atp", type))
            .append(" id=").append(TNEFUtils.getConstName(getClass(), "att", id))
        ...
        try {
            ...
            switch (id) {
                ...
                case attSentFor:
                    ...
                    break;
                case attRecipTable:
                    // recipients are represented by a counted list of MAPI property rows
